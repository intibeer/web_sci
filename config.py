...
def params_setup(cmdline=None):
  ...
  parser.add_argument('--mode', type=str, required=False, help='work mode: train/test/chat')
  
  # path ctrl
  parser.add_argument('--model_name', type=str, default='jujube_1', help='model name, affects data, model, result save path')
  ...
  parser.add_argument('--k', type=int, default=5, help='Number of conversation turns to train on')

  parser.add_argument('--max_train_data_size', type=int, default=0, help='Limit on the size of training data (0: no limit)')
  parser.add_argument('--steps_per_checkpoint', type=int, default=20000, help='How many training steps to do per checkpoint')
  ...
  parser.add_argument('--reward_type', type=str, default='infoflow', help='Reward to type for reinforce_learn, accepts: infoflow, gold, entity, gold')
